...
jQuery.fn.calendario = function(options){
	...
	this.each(function(){
		...
		function preencher_calendario(idCalendario){
			...
			// colocando ou alterando tÃ­tulo do calendário
			...
			// Obtendo o dia da semana do primeiro dia do mÃªs
