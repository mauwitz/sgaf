...
function saidas_qtd () {
    //Verifica se h· no estoque        
    $.post("saidas_verifica_estoque2.php",{
        lote:$("select[name=lote]").val(),
        produto:$("select[name=produto]").val()        
    }, function(valor) {  
        //alert(valor);
        //Verifica se a quantidade digitada È maior que a do estoque
        ...
        if (valor != "") {            
            ...
            if (qtddigitada > qtdestoque) {
                document.forms["form1"].botao_incluir.disabled= true;
                alert ("A quantidade digitada È maior que a quantidade dispon√≠vel no estoque! A quantidade atual deste produto no estoque est· descrito ao lado do campo!");
...
function valida_etiqueta(campo){ 
    ...
    //Conta quantos caracteres foram digitados no cÛdigo da etiqueta
    ...
    //Ao terminar de digitar verifica o codigo digitado e depois faz todos os calculos
        ...
        $.post("saidas_valida_etiqueta.php", {
            ...
            //O produto e lote existem, mas no estoque esse produto n„o est· incluido nesse lote.
                ...
                alert("Este produto n„o consta no estoque do sistema. Por favor, anote o n˙mero desta etiqueta para analisar depois");
                document.forms["form1"].botao_incluir.disabled= true;
            }            
            //O cÛdigo È valido
            else {                    
        ...
        alert ("Erro grav√≠ssimo, o valor da etiqueta tem mais que 14 d√≠gitos");
    }    
} 
